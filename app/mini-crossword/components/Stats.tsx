...
export const Stats = memo(function Stats({ streaks }: StatsProps) {
    ...
    return (
        <div className="flex bg-zinc-800 w-full border-1 border-zinc-600 rounded-2xl justify-between overflow-hidden select-none">
            <div className="flex flex-col w-1/4 items-center border-r-2 border-zinc-600 p-2 hover:bg-zinc-700 hover:brightness-120 transition-all">
            ...
            <div className="flex flex-col w-1/4 items-center p-2 hover:bg-zinc-700 hover:brightness-120 transition-all">
