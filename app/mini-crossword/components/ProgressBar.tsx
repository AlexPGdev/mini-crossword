...
export const ProgressBar = memo(function ProgressBar({ streaks }: ProgressBarProps) {
    ...
    return (
        <div className="flex flex-col bg-zinc-800 w-full border-1 border-zinc-600 rounded-2xl justify-between px-5 py-2 select-none hover:bg-zinc-700 hover:brightness-120 transition-all">
